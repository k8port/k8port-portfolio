        ...
        <div className="absolute inset-4">
          ...
          <div className="flex items-start gap-4">
            <p className="pt-2 text-redblacks-blackplum paragraph-small md:text-lg md:leading-7 text-pretty">
                  ...
                  enduring curiosity, unbounded creativity, and a big-picture perspective.
                  I thrive on the intersection of technology and humanity,
                  where chaos and order vie for supremacy, complexity and simplicity
