...
export async function submitContact(
    ...
    } else if (preference === "email" && !email) return { success: false, error: "Email address required." };
    else if (preference === "text" && !phone) return { success: false, error: "Phone number required." };
    else if (preference === "whatsapp" && !whatsapp) return { success: false, error: "WhatsApp handle required." };
